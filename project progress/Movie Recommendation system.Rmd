...
<div align = "justify">
Earlier, when there are no movie recommendation systems, people use to rely on the
suggestions and recommendations done by other people based on their personal
interests. In order to overcome this, now a days, many OTT platforms such as Netflix,
Amazon Prime Video, Hulu and so on are implementing a special feature, recommendation system, in their application on considering the one’s watch history and
most liked movies. It is possible for business organizations to exploit the usage of these
Recommendation Systems by suggesting items that are lovable to the users. Ever
wondered how these applications suggest or recommend the movies which are appealing to us using such recommendation systems? This system is used to learn the watching patterns of the user and recommends the movies accordingly. We all come across these systems once in a while. These systems are not only used in entertainment applications but they are also used in many E-Commerce websites such as Amazon, Ebay and Best Buy.

We have come up with the similar idea of designing our own Movie recommendation
system which helps the user by recommending the top movies based on his/her
preferences and ratings history. 
...
![popularity based filtering](B:/my-work/kdd/final/Movie_Recommender/The-Schema-for-the-model-based-popularity-mitigation.png)
...
![Content based filtering](B:/my-work/kdd/final/Movie_Recommender/content_based.png)
...
![collaborative filtering](B:/my-work/kdd/final/Movie_Recommender/collaborative_based.png)
...
URL: <https://www5.in.tum.de/lehre/seminare/datamining/ss17/paper_pres/01_pipeline/Data_Mining_Pipeline.pdf>
